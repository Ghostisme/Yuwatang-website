define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'ygame/cert/index?project_id=' + project_id,
                    add_url: 'ygame/cert/add?project_id=' + project_id,
                    edit_url: 'ygame/cert/edit?project_id=' + project_id,
                    del_url: 'ygame/cert/del?project_id=' + project_id,
                    multi_url: 'ygame/cert/multi?project_id=' + project_id,
                    table: 'ygame_result',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'image', title: __('证书模板'),operate:false, events: Table.api.events.image, formatter: Table.api.formatter.image},
                        {field: 'name', title: __('证书名称'), operate: 'LIKE'},
