            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'picture', title: __('学生照片'),operate:false, events: Table.api.events.image, formatter: Table.api.formatter.image},
                        {field: 'province', title: __('省市'), operate: 'LIKE'},
                        {field: 'name', title: __('姓名'), operate: 'LIKE'},
                        {field: 'number', title: __('编号'), operate: 'LIKE'},
                        {field: 'age', title: __('年龄'), operate: 'LIKE'},
                        {field: 'idcard', title: __('身份证'), operate: 'LIKE'},
                        {field: 'register_institution', title: __('报名机构'), operate: 'LIKE'},

                        {field: 'teacher', title: __('指导老师'), operate: false},
                        {field: 'type.name', title: __('作品类型'), operate: false},
                        {field: 'work_name', title: __('作品名称'), operate: false},
                        {field: 'cert.name', title: __('参与荣誉'), operate: false},
                        {field: 'cert_url', title: __('荣誉证书'), operate:false, events: Table.api.events.image, formatter: Table.api.formatter.image},
                            ...
                            buttons: [
                                {
                                    ...
                                    title: __('生成证书'),
                                    text:'生成证书',
                                    classname: 'btn btn-xs btn-default btn-execute btn-ajax',
                                    ...
                                    visible:function (row){
                                        return true;
                                        // if(row.cert_url==null){
                                        //     return true;
                                        // }else{
                                        //     return false
                                        // }
                                    },
                                    url: 'ygame/result/generetaCert?result_id={id}'
                                }]
                        }
                    ]
                ]
